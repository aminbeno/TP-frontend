  ...
  return (
    <Container className="d-flex justify-content-center align-items-center" style={{ height: '100vh' }}>
      <Card style={{ maxWidth: 400, width: '100%' }}>
        <Card.Body>
          <Card.Title className="text-center" style={{ color: '#1B8C3E', fontWeight: 700 }}>
            TaskFlow
          </Card.Title>
          <Card.Subtitle className="text-center text-muted mb-3">Connectez-vous pour continuer</Card.Subtitle>
